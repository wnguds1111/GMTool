...
for i in range(10):
    ...
    if applied:
        manage_html = """
                        <span style="color: #94A3B8; font-size: 14px;">적용 완료</span>"""
    else:
        manage_html = """
                        <button class="btn btn-primary" style="padding: 4px 12px;">샤드 적용</button>
...
print("Updated mail_all.html table with Shard Apply logic and Reward type.")
